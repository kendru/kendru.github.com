...
a source file changed, enabling a very quick feedback cycle. In this chapter, we
...
![The Read-Eval-Print Loop](/img/learn-cljs/chapter7/repl-overview.png)
...
These commands should look familiar from the last chapter, as they are quite
...
![Loading a ClojureScript REPL](/img/learn-cljs/chapter7/loading_figwheel_repl.png)

_Loading a ClojureScript REPL_

A ClojureScript REPL instantly compiles the code that we type in to JavaScript
and evaluates it in the context of a browser. In the previous chapter, we started
...
![REPL-Driven Development Workflow](/img/learn-cljs/chapter7/repl_driven_development.png)

_REPL-Driven Development Workflow_

While we will not use this full workflow in this chapter, we will explore the
...
![Breaking Down the REPL](/img/learn-cljs/chapter7/repl_breakdown.png)
...
![Figwheel Client/Server Communication](/img/learn-cljs/chapter7/figwheel-overview.png)
...
#### Browser interaction from the REPL
...
*NOTE:* Anything that we have defined in the REPL will only last until we close or
...
From this short REPL section, we now have some clean, refactored code that we
...
In this chapter, we explored how to use the REPL to interact with a web page. We
