...
![Leiningen Template Resolution](/img/learn-cljs/chapter5/lein-template-resolution.png)
...
![Dissecting a lein new Command](/img/learn-cljs/chapter5/new_new_dissected.png)
...
![Editing core.cljs with Emacs](/img/learn-cljs/chapter5/emacs_screenshot.png)

_Editing `core.cljs` with Emacs_

We will dig in to the rest of this file over the next couple of chapters, as we
...
![Filename to Namespace Convention](/img/learn-cljs/chapter5/namespace-transformation.png)
...
In this chapter, we have walked through the process of creating a new
